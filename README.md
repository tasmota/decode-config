...
#### Windows 10
Use the Windows executable file [decode-config_x64.exe](https://github.com/tasmota/decode-config/blob/development/decode-config_x64.exe), No need to install anything.
